...
unsigned int nStakeMinAge = 60 * 60 * 6;   // minimum age for coin age: 6 hours
...
int64 nChainStartTime = 1426057200;
...
const string strMessageMagic = "PlanetCoin Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in PlanetCoin
    bool fStrictPayToScriptHash = true; // Always active in PlanetCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "PlanetCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Save the planet";
        CTransaction txNew;
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0x1766782871440057249514d25e08b20bb94fcc10608efcf76b9fc7ecce0085b1"));
